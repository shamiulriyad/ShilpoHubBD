...
public class UpdateResearchPublicationRequestValidator : AbstractValidator<UpdateResearchPublicationRequest>
{
    public UpdateResearchPublicationRequestValidator()
    {
        ...
        RuleFor(x => x.Type)
            .NotEmpty()
            .Must(t => Enum.TryParse<ResearchPublicationType>(t, true, out _))
