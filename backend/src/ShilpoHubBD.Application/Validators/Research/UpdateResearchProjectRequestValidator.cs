...
public class UpdateResearchProjectRequestValidator : AbstractValidator<UpdateResearchProjectRequest>
{
    public UpdateResearchProjectRequestValidator()
    {
        ...
        RuleFor(x => x.Visibility)
            .NotEmpty()
            .Must(v => Enum.TryParse<ResearchProjectVisibility>(v, true, out _))
