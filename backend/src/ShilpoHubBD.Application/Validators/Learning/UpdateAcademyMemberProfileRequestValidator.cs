...
public class UpdateAcademyMemberProfileRequestValidator : AbstractValidator<UpdateAcademyMemberProfileRequest>
{
    public UpdateAcademyMemberProfileRequestValidator()
    {
