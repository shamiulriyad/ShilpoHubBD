...
public class UpdateSurveyResponseRequestValidator : AbstractValidator<UpdateSurveyResponseRequest>
{
    public UpdateSurveyResponseRequestValidator()
    {
        ...
        RuleFor(x => x.Source)
            .NotEmpty()
            .Must(s => Enum.TryParse<FieldResponseSource>(s, true, out _))
