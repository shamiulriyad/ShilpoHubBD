...
public class CreateHeritageRiskRecordRequestValidator : AbstractValidator<CreateHeritageRiskRecordRequest>
{
    public CreateHeritageRiskRecordRequestValidator()
    {
