...
{
    Task<(List<LiveEvent> Items, int TotalCount)> GetPagedAsync(LiveEventStatus? status, int page, int pageSize, CancellationToken cancellationToken, Guid? producerId = null);
