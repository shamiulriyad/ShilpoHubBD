...
public interface ICustomOrderService
{
    ...
    Task<CustomOrderRequestDto> UpdateDeliveryAsync(Guid id, Guid customerId, UpdateCustomOrderDeliveryRequest request, CancellationToken cancellationToken);
    Task<CustomOrderRequestDto> ShipAsync(Guid id, Guid producerId, bool isAdmin, ShipCustomOrderRequest request, CancellationToken cancellationToken);
