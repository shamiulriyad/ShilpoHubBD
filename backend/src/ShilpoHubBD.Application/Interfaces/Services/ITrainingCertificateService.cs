...
public interface ITrainingCertificateService
{
    ...
    Task<List<TrainingCertificateDto>> GetMineAsync(Guid recipientUserId, CancellationToken cancellationToken);
    ...
    Task<TrainingCertificateDto> IssueSkillCertificateAsync(Guid issuerUserId, IssueSkillCertificateRequest request, CancellationToken cancellationToken);
