...
export const investmentOpportunitiesService = {
  ...
  mine: (params) => apiClient.get('/investment-opportunities/mine', { params }).then((res) => res.data),
  ...
  opportunityProposals: (id, params) => apiClient.get(`/investment-opportunities/${id}/proposals`, { params }).then((res) => res.data),
