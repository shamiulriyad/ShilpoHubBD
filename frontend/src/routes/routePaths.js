export const routePaths = {
  ...
  tourist: '/tourist',
  workspaceTouristCrafts: '/tourist/crafts',
  workspaceTouristMap: '/tourist/map',
  workspaceTouristFestivals: '/tourist/festivals',
  workspaceTouristEvents: '/tourist/events',
  workspaceTouristRoutes: '/tourist/routes',
  workspaceTouristVillages: '/tourist/villages',
  workspaceTouristCuisines: '/tourist/cuisines',
  workspaceTouristServices: '/tourist/services',
  workspaceTouristBookings: '/tourist/bookings',
  workspaceTouristPassport: '/tourist/passport',
  workspaceTouristAiPlanner: '/tourist/ai-planner',
  workspaceAcademyCatalog: '/academy-member/courses',
  workspaceAcademyMentors: '/academy-member/mentors',
  workspaceAcademyLiveClasses: '/academy-member/live-classes',
  workspaceAcademyCertifications: '/academy-member/certifications',
