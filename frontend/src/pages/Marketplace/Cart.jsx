...
import { PageHeader, Button, AsyncState, CartItem } from '../../components/ui';
...
export default function Cart() {
  ...
  const summaryQuery = useCartSummary(isAuthenticated);
      ...
      {!isAuthenticated ? (
        ...
        <div className="grid gap-8 lg:grid-cols-[2fr_1fr]">
          ...
          <div className="h-fit space-y-4 rounded-xl border border-border bg-surface p-5">
            ...
            <Link to={routePaths.marketplaceCheckout}>
