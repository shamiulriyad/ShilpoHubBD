...
import { toPlace, normaliseDistrict, hasCoordinates } from '../../utils/tourismAdapters';
...
export default function HeritageMap() {
  ...
  const places=useMemo(()=>{
    return (query.data?.items||[]).map(toPlace);
  },[query.data]);
