...
export default function LocalCuisines() {
  ...
  const records=(query.data?.items||[]).map(c=>({...c,kind:c.kind||'Local dish',districtName:c.isNationwide?NATIONWIDE:c.districtName,source:c.sourceUrl}));
